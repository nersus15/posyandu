<?php
    function dariMap($nilai, $map = [], $def = null){
        ...
        return !c_isset($map, $nilai) ? $def : $map[$nilai];
    }
    $mapPenolong = [
        "1" => "Keluarga",
        "2" => "Dukun",
    ...
    <div class="card card-default">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12">
                    <ul style="list-style: none;">
                        <li>Puskesmas: <b><?= $kunjungan['petugas']['faskes'] ?></b></li>
                ...
                <div class="col-sm-12 col-md-6">
                    <ul style="list-style: none;">
                        <li>Umur: <b><?= $umur ?></b></li>
                        <li>RT/RW: <b><?= isset($rt) ? $rt : '-' ?></b></li>
                        <li>Kecamatan: <b><?= $kecamatan['nama'] ?></b></li>
                        <li>Prov: <b><?= 'Nusa Tenggara Barat' ?></b></li>
                        <li>Agama: <b><?= $agama ?></b></li>
                        <li>Tgl Register: <b><?= substr($dibuat, 0, 10) ?></b></li>
                    </ul>
                </div>
            ...
            <div class="row mt-2">
                ...
                <div class="col-sm-12">
                    <ul style="list-style: none;">
                        <li>Riwayat Komplikasi Kebidanan: <p><?= $kunjungan['riwayat_komplikasi'] ?></p></li>
                        <li>Penyakit Kronis dan Alergi <p><?= $kunjungan['penyakit'] ?></p></li>
                    </ul>
                </div>
                ...
                <div class="col-sm-12">
                    ...
                    <ul style="list-style: none;">
                        ...
                        <li>Persediaan kain handuk, pakaian bayi bersih dan kering: <p><?= $kunjungan['persalinan_persedian'] ?></p></li>
                    </ul>
                </div>
            </div>
        </div>
