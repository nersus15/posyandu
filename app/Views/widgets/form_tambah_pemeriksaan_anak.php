        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Form Pemeriksaan Anak</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6">
                            ...
                            <div class="form-group">
                                <label for="">Berat (dalam gr) <span class="symbol-required"></span></label>
                        ...
                        <div class="col-sm-12 col-md-6">
                            ...
                            <div class="form-group">
                                <label for="">Tinggi (dalam cm) <span class="symbol-required"></span></label>
                                <input type="number" name="tinggi" min="0" required id="tinggi" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
