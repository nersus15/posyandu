...
// Laporan
$routes->get('/laporan/bumil', 'Bumil::laporan', ['filter' => 'MustLogin:kader;bidan']);
$routes->get('/laporan/lansia', 'Lansia::laporan', ['filter' => 'MustLogin:kader']);
$routes->get('/laporan/anak', 'Anak::laporan', ['filter' => 'MustLogin:kader']);
$routes->get('/laporan/bumil/(:any)', 'Bumil::laporan/$1', ['filter' => 'MustLogin:kader;bidan']);
$routes->get('/laporan/lansia/(:any)', 'Lansia::laporan/$1', ['filter' => 'MustLogin:kader']);
$routes->get('/laporan/anak/(:any)', 'Anak::laporan/$1', ['filter' => 'MustLogin:kader']);
